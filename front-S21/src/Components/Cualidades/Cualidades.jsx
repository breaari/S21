...
export const Cualidades = () => {
    return (
        <div className="relative w-full h-auto pb-[50px] mq980:pb-[20px] flex justify-center items-center flex-col">
            ...
            <div className="mq980:flex-col flex-row flex items-center justify-center"> 
                ...
                <div className="w-[220px] text-center flex justify-center items-center flex-col mb-[25px] mr-[40px] mq980:mr-[0px]">
                    <div className="rounded-[55px] bg-verde mt-[35px] mq980:mt-[8px] w-[94px] h-[94px] p-[0.5px] items-center flex justify-center my-[15px]">
