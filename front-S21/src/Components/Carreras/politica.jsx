...
export const Politica = () => {
    ...
    const carreras = [
        ...
        { nombre: "Tec. en Promoción Comunitaria en Niñez y Adolesc.", nueva: false },
    ...
    return (
        ...
        //             <img src={politicaimage} className="w-[40px] mx-2 mq980:w-[60px] mq980:mx-0 mq980:mb-4" alt="Política" />
        //         </div>
        //         Política
        //     </div>
