...
export const Administracion = () => {
  ...
  const carreras = [
    ...
    {
      nombre: "Licenciatura en Desarrollo de Negocios Inmobiliarios (CCC)",
      nueva: false,
    },
    ...
    { nombre: "Licenciatura en Ambiente y Energías Renovables", nueva: true },
    { nombre: "Licenciatura en Gestión Deportiva", nueva: false },
    ...
    {
      nombre: "Tecnicatura en Gestión Administrativa de Servicios de Salud",
      nueva: false,
    },
    { nombre: "Tec. en Gestión de Recursos Turísticos", nueva: false },
    { nombre: "Tec. en Gestión y Auditorías Ambientales", nueva: false },
    { nombre: "Tec. en Negocios Agroecológicos", nueva: true },
    {
      nombre:
        "Tec. en Administración de la Propiedad Horizontal y Conjuntos Inmobiliarios",
      nueva: false,
    },

    {
      nombre: "Tec. en Gestión del Clima Laboral en la Organización",
      nueva: false,
    },

    {
      nombre: "Especialización en Gestión de Energías Renovables",
      nueva: true,
    },
    {
      nombre: "Especialización en Finanzas Corporativas y Mercado de Capitales",
      nueva: false,
    },
    {
      nombre: "Especialización en Gestión y Gobierno de Empresas Familiares",
      nueva: false,
    },
    { nombre: "Maestría en Administración de Empresas", nueva: false },
    {
      nombre: "Maestría en Adm. de Neg. y Ap. Tec. en la Empresa",
      nueva: false,
    },
  ];
