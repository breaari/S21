export const preguntasStudents = {
  "Verdadero o falso": [
    {
      id: "vf-1",
    ...
    },
    {
      id: "vf-13",
      tipo: "verdadero-falso",
      pregunta: "Cualquier estudiante puede cursar materias de verano.",
      respuestaCorrecta: false,
      explicacion:
  ...
  "Multiple choice": [
    ...
    },
    {
      ...
      opciones: [
        {
          id: "a",
          texto: "Una materia electiva habilitada para el plan de estudios.",
        },
        {
          id: "b",
          texto: "Una materia electiva relacionada con otro campo profesional.",
        },
        {
          id: "c",
    ...
    },
    {
      ...
      opciones: [
        {
          id: "a",
          texto: "En el calendario académico",
        },
        {
          id: "b",
          texto: "En Klarway, el mismo portal que se utiliza para rendir.",
        },
        {
          id: "c",
          texto:
        ...
        {
          id: "d",
          texto: "En la página pública de la carrera.",
        },
      ],
      respuestaCorrecta: "a",
      explicacion:
    ...
    },
    {
      ...
      opciones: [
        ...
        {
          id: "c",
          texto: "Son evaluaciones que reemplazan los trabajos prácticos.",
        },
        {
          id: "d",
          texto:
    ...
    },
    {
      id: "mc-13",
      tipo: "multiple-choice",
      pregunta: "¿Qué hace que una materia sea considerada una materia extra?",
      opciones: [
        {
          id: "a",
          texto:
        ...
        {
          id: "b",
          texto: "Que se dicte fuera del calendario académico regular.",
        },
        {
          id: "c",
          texto: "Que no otorgue créditos para completar el plan de estudios.",
        },
        {
          id: "d",
          texto:
    ...
    },
    {
      id: "mc-18",
      tipo: "multiple-choice",
      pregunta: "¿Dónde se realizan los parciales y finales?",
      opciones: [
        {
          id: "a",
          texto: "Únicamente de manera virtual, a través de SOE (Klarway).",
        },
        {
          id: "b",
          texto:
  ...
  "Carrera misteriosa": [
    ...
    },
    {
      ...
      respuestaCorrecta: "Licenciatura en Ambiente y Energías Renovables",
      explicacion:
    ...
    },
    {
      ...
      respuestaCorrecta: "Licenciatura en Agroinformática",
      explicacion:
    ...
    },
    {
      ...
      respuestaCorrecta: "Licenciatura en Administración Pública",
      explicacion:
